...
//             String type = "dot";
            ...
            // String type = "png";
            // String type = "plain";
            File out = new File("E:/CapabilityModel/out." + type);
            gv.writeGraphToFile(gv.getGraph(gv.getDotSource(), type), out);
    }


    public void start2() {
            String input = "E:/CapabilityModel/testfile.gv";
            GraphViz gv = new GraphViz();
            gv.readSource(input);
            System.out.println(gv.getDotSource());
            ...
            File out = new File("E:/CapabilityModel/out." + type);
            try {
				FileWriter fileWriter = new FileWriter("E://CapabilityModel//out."+type, false);
			} catch (IOException e) {
